...
var (
	...
	ApplicationGroupsColumns = []*schema.Column{
		...
		{Name: "group_logo", Type: field.TypeString},
	...
	ApplicationResourcesColumns = []*schema.Column{
		...
		{Name: "resource_description", Type: field.TypeString},
		{Name: "type", Type: field.TypeEnum, Enums: []string{"API", "BUTTON", "DATA", "MENU"}, Default: "API"},
	...
	ApplicationUsersColumns = []*schema.Column{
		...
		{Name: "app_id", Type: field.TypeString},
		{Name: "user_id", Type: field.TypeUUID},
		{Name: "create_method", Type: field.TypeEnum, Enums: []string{"signup", "admin_add"}, Default: "signup"},
		{Name: "create_at", Type: field.TypeInt64},
		{Name: "delete_at", Type: field.TypeInt64},
	}
	...
	ApplicationUsersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "applicationuser_create_method",
				Unique:  false,
