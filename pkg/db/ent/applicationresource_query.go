...
func (arq *ApplicationResourceQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (arq *ApplicationResourceQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
// Returns a *NotSingularError when exactly one ApplicationResource entity is not found.
...
// Returns a *NotSingularError when exactly one ApplicationResource ID is not found.
// Returns a *NotFoundError when no entities are found.
func (arq *ApplicationResourceQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (arq *ApplicationResourceQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (arq *ApplicationResourceQuery) IDs(ctx context.Context) ([]uuid.UUID, error) {
	var ids []uuid.UUID
...
func (arq *ApplicationResourceQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := arq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (arq *ApplicationResourceQuery) sqlAll(ctx context.Context) ([]*ApplicationResource, error) {
	var (
...
func (arq *ApplicationResourceQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (argb *ApplicationResourceGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (argb *ApplicationResourceGroupBy) ScanX(ctx context.Context, v interface{}) {
...
func (argb *ApplicationResourceGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(argb.fields) > 1 {
		return nil, errors.New("ent: ApplicationResourceGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := argb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (argb *ApplicationResourceGroupBy) StringsX(ctx context.Context) []string {
...
// It is only allowed when executing a group-by query with one field.
func (argb *ApplicationResourceGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{applicationresource.Label}
	default:
		err = fmt.Errorf("ent: ApplicationResourceGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (argb *ApplicationResourceGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (argb *ApplicationResourceGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(argb.fields) > 1 {
		return nil, errors.New("ent: ApplicationResourceGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := argb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (argb *ApplicationResourceGroupBy) IntsX(ctx context.Context) []int {
	v, err := argb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (argb *ApplicationResourceGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{applicationresource.Label}
	default:
		err = fmt.Errorf("ent: ApplicationResourceGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (argb *ApplicationResourceGroupBy) IntX(ctx context.Context) int {
	v, err := argb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (argb *ApplicationResourceGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(argb.fields) > 1 {
		return nil, errors.New("ent: ApplicationResourceGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := argb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (argb *ApplicationResourceGroupBy) Float64sX(ctx context.Context) []float64 {
...
// It is only allowed when executing a group-by query with one field.
func (argb *ApplicationResourceGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{applicationresource.Label}
	default:
		err = fmt.Errorf("ent: ApplicationResourceGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (argb *ApplicationResourceGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (argb *ApplicationResourceGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(argb.fields) > 1 {
		return nil, errors.New("ent: ApplicationResourceGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := argb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (argb *ApplicationResourceGroupBy) BoolsX(ctx context.Context) []bool {
...
// It is only allowed when executing a group-by query with one field.
func (argb *ApplicationResourceGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{applicationresource.Label}
	default:
		err = fmt.Errorf("ent: ApplicationResourceGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (argb *ApplicationResourceGroupBy) BoolX(ctx context.Context) bool {
	v, err := argb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
func (argb *ApplicationResourceGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (argb *ApplicationResourceGroupBy) sqlQuery() *sql.Selector {
...
func (ars *ApplicationResourceSelect) Scan(ctx context.Context, v interface{}) error {
	if err := ars.prepareQuery(ctx); err != nil {
		return err
	}
	ars.sql = ars.ApplicationResourceQuery.sqlQuery(ctx)
	return ars.sqlScan(ctx, v)
}

// ScanX is like Scan, but panics if an error occurs.
func (ars *ApplicationResourceSelect) ScanX(ctx context.Context, v interface{}) {
...
func (ars *ApplicationResourceSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ars.fields) > 1 {
		return nil, errors.New("ent: ApplicationResourceSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ars.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (ars *ApplicationResourceSelect) StringsX(ctx context.Context) []string {
...
func (ars *ApplicationResourceSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{applicationresource.Label}
	default:
		err = fmt.Errorf("ent: ApplicationResourceSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (ars *ApplicationResourceSelect) StringX(ctx context.Context) string {
...
func (ars *ApplicationResourceSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ars.fields) > 1 {
		return nil, errors.New("ent: ApplicationResourceSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ars.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (ars *ApplicationResourceSelect) IntsX(ctx context.Context) []int {
	v, err := ars.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (ars *ApplicationResourceSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{applicationresource.Label}
	default:
		err = fmt.Errorf("ent: ApplicationResourceSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (ars *ApplicationResourceSelect) IntX(ctx context.Context) int {
	v, err := ars.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (ars *ApplicationResourceSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ars.fields) > 1 {
		return nil, errors.New("ent: ApplicationResourceSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ars.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (ars *ApplicationResourceSelect) Float64sX(ctx context.Context) []float64 {
...
func (ars *ApplicationResourceSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{applicationresource.Label}
	default:
		err = fmt.Errorf("ent: ApplicationResourceSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (ars *ApplicationResourceSelect) Float64X(ctx context.Context) float64 {
...
func (ars *ApplicationResourceSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ars.fields) > 1 {
		return nil, errors.New("ent: ApplicationResourceSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ars.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (ars *ApplicationResourceSelect) BoolsX(ctx context.Context) []bool {
	v, err := ars.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (ars *ApplicationResourceSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{applicationresource.Label}
	default:
		err = fmt.Errorf("ent: ApplicationResourceSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (ars *ApplicationResourceSelect) BoolX(ctx context.Context) bool {
	v, err := ars.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
func (ars *ApplicationResourceSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
