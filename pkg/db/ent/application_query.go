...
// Returns a *NotSingularError when exactly one Application entity is not found.
...
//		GroupBy(application.FieldApplicationName).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
...
//
//	client.Application.Query().
//		Select(application.FieldApplicationName).
//		Scan(ctx, &v)
//
func (aq *ApplicationQuery) Select(fields ...string) *ApplicationSelect {
	aq.fields = append(aq.fields, fields...)
	return &ApplicationSelect{ApplicationQuery: aq}
}
...
func (as *ApplicationSelect) Scan(ctx context.Context, v interface{}) error {
	...
	as.sql = as.ApplicationQuery.sqlQuery(ctx)
