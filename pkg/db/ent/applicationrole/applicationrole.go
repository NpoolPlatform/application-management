...
const (
	// Label holds the string label denoting the applicationrole type in the database.
	Label = "application_role"
	...
	// Table holds the table name of the applicationrole in the database.
	Table = "application_roles"
)

// Columns holds all SQL columns for applicationrole fields.
var Columns = []string{
	FieldID,
	FieldAppID,
	FieldRoleName,
